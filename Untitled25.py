...
import numpy as np
import cv2
Healthy = cv2.CascadeClassifier('Content\\project\\haarcascade_healthy.xml')
bacterial_spot = cv2.CascadeClassifier('\Content\\HP\\project\\haarcascade_Bacterial_spot_.xml')
Early_blight = cv2.CascadeClassifier('\Content\\HP\\project\\haarcascade_Early_blight.xml')
Late_blight = cv2.CascadeClassifier('\Content\\HP\\project\\haarcascade_Late_blight.xml')
Leaf_mold = cv2.CascadeClassifier('\Content\\HP\\project\\haarcascade_Leaf_Mold.xml')
Septoria_leaf_spot = cv2.CascadeClassifier('\Content\\HP\\project\\haarcascade_Septoria_leaf_spot.xml')
Spider_mites = cv2.CascadeClassifier('\Content\\HP\\project\\hasscascade_Spider_mites.xml')
Target_Spot = cv2.CascadeClassifier('\Content\\HP\\project\\hasscascade_Target_Spot.xml')
Mosaic_virus = cv2.CascadeClassifier('\Content\\HP\\project\\hasscascade_Mosaic_virus.xml')
Curl_Virus = cv2.CascadeClassifier('\Content\\HP\\project\\hasscascade_Tomato_Yellow_Curl_Virus.xml')
